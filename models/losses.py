...
class Blur(nn.Module):
    def __init__(self, nc):
        ...
        kernel = th.from_numpy(kernel).permute(2, 3, 0, 1)
...
class ColorLoss(nn.Module):
    ...
    def forward(self, x1, x2):
        return th.sum(th.pow((x1 - x2), 2)).div(2 * x1.size()[0])
...
if __name__ == '__main__':
    ...
    # rgb example
    blur_rgb = Blur(3)
    img_rgb1 = th.randn(4, 3, 40, 40)
    img_rgb2 = th.randn(4, 3, 40, 40)
    ...
    # gray example
    blur_gray = Blur(1)
    img_gray1 = th.randn(4, 1, 40, 40)
    img_gray2 = th.randn(4, 1, 40, 40)
